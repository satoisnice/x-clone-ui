    ...
    >
      ...
      <div className="flex-1 flex-col gap-4">
        <input
          ...
          className="bg-transparent outline-none placeholder:text-text-textGray text-xl"
        />
        {/* PREVIEW IMAGE */}
        {media?.type.includes("image") && previewURL && (
          <div className="relative rounded-xl overflow-hidden">
            ...
            />
            <div
              className="absolute top-2 left-2 bg-black bg-opacity-50 text-white py-1 px-4 rounded-full font-bond text-sm cursor-pointer"
